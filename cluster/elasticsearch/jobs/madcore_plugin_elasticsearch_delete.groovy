	    ...
	    cps {
            ...
            node {
                ...
                stage('Elasticsearch: wait for elasticsearch cluster to stop') {
                    build job: 'madcore.kubectl.wait.service.down', parameters: [string(name: 'APP_NAME', value: params.APP_NAME), string(name: 'SERVICE_NAME', value: 'es-master:9300'), string(name: 'SERVICE_NAMESPACE', value: 'es-cluster')]
                }
