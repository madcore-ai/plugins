	    ...
	    cps {
            ...
            node {
                ...
                stage('Elasticsearch: create services') {
                    build job: 'madcore.kubectl.create', parameters: [string(name: 'FILENAME', value: 'cluster/elasticsearch/kub/services')]
                }
                stage('Elasticsearch: create master') {
                    build job: 'madcore.kubectl.create', parameters: [string(name: 'FILENAME', value: 'cluster/elasticsearch/kub/es-master-rc.yaml')]
                }
                ...
                stage('Elasticsearch: create client') {
                    build job: 'madcore.kubectl.create', parameters: [string(name: 'FILENAME', value: 'cluster/elasticsearch/kub/es-client-rc.yaml')]
                }
                ...
                stage('Elasticsearch: create data') {
                    build job: 'madcore.kubectl.create', parameters: [string(name: 'FILENAME', value: 'cluster/elasticsearch/kub/es-data-rc.yaml')]
                }
