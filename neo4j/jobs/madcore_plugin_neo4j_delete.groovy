	    ...
	    cps {
            ...
            node {
                ...
                stage('Neo4j: wait for neo4j cluster to stop') {
                    build job: 'madcore.kubectl.wait.service.down', parameters: [string(name: 'APP_NAME', value: params.APP_NAME), string(name: 'SERVICE_NAME', value: 'neo4j-master:7474'), string(name: 'SERVICE_NAMESPACE', value: 'neo4j-cluster')]
                }
